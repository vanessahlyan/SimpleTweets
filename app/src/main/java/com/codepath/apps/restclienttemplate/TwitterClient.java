...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "CumUeShLXWazv8Aq9vqQfhpud";
    public static final String REST_CONSUMER_SECRET = "PvHyQUxljIS24dXp0b9zTKUPKIy1DH0HMgsnHJq4calLqDRL54";
